 ...
 * @class CMiniDumper 
 *
 * Mini dump class to debug runtime error
 */
class CMiniDumper
{
	const static int USER_DATA_BUFFER_SIZE = 4096;

public:
	CMiniDumper(bool headless);

protected:
	static CMiniDumper *gpDumper;
	...
	virtual const wchar_t *VGetUserMessage() { return NULL; }
